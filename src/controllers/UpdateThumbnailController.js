...
/**
 * o controller pra atualizar a url da thumbnail do video cadastrado
 ...
 * uploads e atualizar a url da thumbnail no banco
 */
...
module.exports = {
  async update(request, response) {
    ...
    const urlThumbnail = `${process.env.URL_LOCALHOST}/files/${file.filename}`;

    try {
      await Video.findOneAndUpdate({ id: video_id }, { urlThumbnail });
